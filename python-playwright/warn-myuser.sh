...
if [ "$IN_PYTHON_IMAGE" = true ]; then
    cat <<EOF
This Docker image is now being ran as the user '$WHOAMI', and with the WORKDIR set to '/home/myuser'.

If you encounter any issues because of this, you may need to do some changes in your Dockerfile.
Please refer to the following documentation for how to solve common issues: https://docs.crawlee.dev/vlad-is-writing-a-url-we-need-documentation-for-thissss
EOF
